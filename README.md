...
| Project 2    | Tested a mobile application for compatibility across different devices. | JIra, Zephyr |
| Project 3    | Tested a desktop application for security vulnerabilities. | Jira, Zephyr |
